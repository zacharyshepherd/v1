...
const navigation = {
  ...
  social: [
    {
      name: 'GitHub',
      href: 'https://github.com/zacharyshepherd',
      icon: (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/zachary_shepherd/',
      icon: (
        <svg fill="currentColor" aria-hidden="true" className="h-6 w-6" viewBox="0 0 24 24">
          <path
            fillRule="evenodd"
    ...
    },
    {
      ...
      icon: (
        <svg fill="currentColor" aria-hidden="true" className="h-6 w-6" viewBox="0 0 24 24">
          <path
            d="M20.447 20.452h-3.724v-5.569c0-1.327-.026-3.036-1.85-3.036-1.852 0-2.135 1.447-2.135 2.944v5.661H9.014V9h3.576v1.561h.051c.498-.947 1.712-1.946 3.523-1.946 3.76 0 4.454 2.475 4.454 5.694v6.143zM5.337 7.433c-1.2 0-2.172-.974-2.172-2.172 0-1.198.972-2.171 2.172-2.171 1.197 0 2.171.973 2.171 2.171 0 1.198-.974 2.172-2.171 2.172zm1.861 13.019H3.475V9h3.723v11.452zm14.912-20.452H2.892C1.297 0 0 1.297 0 2.892v18.217C0 22.703 1.297 24 2.892 24h18.217C22.703 24 24 22.703 24 21.108V2.892C24 1.297 22.703 0 21.108 0z"
          />
      </svg>
      ),
    },
        ...
        <nav aria-label="Global" className="mx-auto flex items-center justify-between px-6">
          <div className="flex lg:flex-1">
            <button className="-m-1.5 p-1.5" onClick={() => {
              ...
              <svg className='active' xmlns="http://www.w3.org/2000/svg" width="40" zoomAndPan="magnify" viewBox="0 0 75 74.999997" height="75" preserveAspectRatio="xMidYMid meet" version="1.0"><defs><g></g><clipPath id="00e7f4d56e"><path d="M 2.023438 2.15625 L 73.273438 2.15625 L 73.273438 73.40625 L 2.023438 73.40625 Z M 2.023438 2.15625 " clip-rule="nonzero" className="svg-elem-1"></path></clipPath><clipPath id="0ace7073a7"><path d="M 8.023438 2.15625 L 67.121094 2.15625 C 70.4375 2.15625 73.121094 4.84375 73.121094 8.15625 L 73.121094 67.253906 C 73.121094 70.570312 70.4375 73.253906 67.121094 73.253906 L 8.023438 73.253906 C 4.710938 73.253906 2.023438 70.570312 2.023438 67.253906 L 2.023438 8.15625 C 2.023438 4.84375 4.710938 2.15625 8.023438 2.15625 Z M 8.023438 2.15625 " clip-rule="nonzero" className="svg-elem-2"></path></clipPath></defs><g clip-path="url(#00e7f4d56e)"><g clip-path="url(#0ace7073a7)"><path stroke-linecap="butt" transform="matrix(0.75, 0, 0, 0.75, 2.025001, 2.157129)" fill="none" stroke-linejoin="miter" d="M 7.997916 -0.00117184 L 86.794797 -0.00117184 C 91.216672 -0.00117184 94.794798 3.582162 94.794798 7.998829 L 94.794798 86.79571 C 94.794798 91.217586 91.216672 94.795711 86.794797 94.795711 L 7.997916 94.795711 C 3.581249 94.795711 -0.00208511 91.217586 -0.00208511 86.79571 L -0.00208511 7.998829 C -0.00208511 3.582162 3.581249 -0.00117184 7.997916 -0.00117184 Z M 7.997916 -0.00117184 " stroke="#22d3ee" stroke-width="16" stroke-opacity="1" stroke-miterlimit="4" className="svg-elem-3"></path></g></g><g fill="#22d3ee" fill-opacity="1"><g transform="translate(16.473825, 58.300005)"><g><path d="M 4.46875 0 L 4.46875 -7 L 25.21875 -32.6875 L 25.21875 -33 L 5.1875 -33 L 5.1875 -42.375 L 39.375 -42.375 L 39.375 -34.734375 L 19.890625 -9.6875 L 19.890625 -9.375 L 40.078125 -9.375 L 40.078125 0 Z M 4.46875 0 " className="svg-elem-4"></path></g></g></g></svg>            
              </button>        
            </div>
          ...
          <div className="mx-auto text-center max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
            ...
            <div className="mt-10 flex justify-center space-x-10">
              {navigation.social.map((item) => (
                <a key={item.name} href={item.href} target='_blank' className="text-slate-400 hover:text-cyan-400">
